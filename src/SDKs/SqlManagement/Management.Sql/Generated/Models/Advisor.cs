...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class Advisor : ProxyResource
    {
        ...
        /// Auto-execute status can be set on (and inhertied from) different
        /// levels in the resource heirarchy. Possible values are
        ...
        /// is inherited. Auto-execute status can be set on (and inhertied
        /// from) different levels in the resource heirarchy. Possible values
